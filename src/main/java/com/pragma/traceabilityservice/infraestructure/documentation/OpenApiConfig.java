package com.pragma.traceabilityservice.infraestructure.documentation;
...
public class OpenApiConfig {
    ...
    public OpenAPI openApiConfiguration() {
        ...
        var exceptionSchema = new Schema<Map<String, String>>()
                .addProperty("message", new StringSchema().example("error"));

        return new OpenAPI()
                .info(new Info()
                        .title("Microservice Traceability hexagonal")
